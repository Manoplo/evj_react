...
const SingleUser = () => {
  ...
  const handleAccountChange = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://www.elvestidordejuliettaapi.tk/api/v1/admin/users/activate",
        {
          id: userId,
          active: activeValue,
        }
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/users/" + userId,
          {
            headers: adminHeader(),
          }
        );
    ...
    const fetchOrders = async () => {
      try {
        const response = await axios(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/orders/new/" +
            userId,
          {
            headers: adminHeader(),
          }
