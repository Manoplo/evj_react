...
const Stats = () => {
  ...
  useEffect(() => {
    const fetchTopSold = async () => {
      try {
        const response = await axios.get(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/stats/top"
        );
    ...
    const fetchTopCategories = async () => {
      try {
        const response = await axios.get(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/stats/top-categories"
        );
        console.log(response);
    ...
    const fetchTopUsers = async () => {
      try {
        const response = await axios.get(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/stats/buyers"
        );
        console.log(response);
    ...
    const fetchTopUusers = async () => {
      try {
        const response = await axios.get(
          "https://www.elvestidordejuliettaapi.tk/api/v1/admin/stats/unregistered"
        );
        console.log(response);
